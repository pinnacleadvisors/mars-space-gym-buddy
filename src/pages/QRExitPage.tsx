...
import { QrCode, LogOut, MapPin, AlertCircle } from "lucide-react";
        ...
        (position) => {
          ...
          if (distance <= MAX_DISTANCE_METERS) {
            ...
            toast({
              ...
              description: "You must be at SE16 2RW, London to check out.",
            });
          }
        },
        (error) => {
      ...
      <Card className="w-full max-w-md shadow-lg">
        {!membershipChecking && !hasMembership && (
          <Alert variant="destructive" className="m-4">
            ...
            <AlertDescription>
              You need an active paid membership to check out. Please contact admin.
            </AlertDescription>
          </Alert>
        )}
        <CardHeader className="text-center">
          ...
          <CardDescription>Scan your QR code to exit the gym</CardDescription>
